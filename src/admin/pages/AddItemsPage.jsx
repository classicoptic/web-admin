...
const AddItemsPage = () => {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      isNaN(Number(formData.minStockQty)) ||
      Number(formData.minStockQty) < 0
    )
      newErrors.minStockQty = "Min. stock qty cannot be negative";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataForSubmit.append("minStockQty", formData.minStockQty.toString());
      ...
      console.log("Form data being submitted:", {
        ...
        minStockQty: formData.minStockQty,
      ...
      const response = await axios.post(
        "https://web-backend-eta.vercel.app/api/product/add",
        formDataForSubmit,
        {
          headers: {
      ...
      Swal.fire({
        ...
        text:
          ...
          `Failed to add. ${JSON.stringify(error.response.data)}`,
        icon: "error",
        confirmButtonColor: "#d33",
      });
